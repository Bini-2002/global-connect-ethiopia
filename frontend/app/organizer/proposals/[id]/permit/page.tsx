...
export default function OrganizerPermitPage() {
  ...
  const [verificationLetter, setVerificationLetter] =
    useState<VerificationLetterRecord | null>(null);
  ...
  useEffect(() => {
    Promise.all([
      ...
      api
        .get<VerificationLetterRecord>(`/verification-letters/${id}`)
        .catch(() => null),
    ])
        ...
        <div className="max-w-5xl mx-auto animate-fade-in">
          <div className="mb-6">
            ...
            <p className="text-slate-500 text-sm mt-1">
              View the municipal permit and the separate verification letter
              generated during final approval.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-12 text-center">
              ...
              <p className="text-slate-500 mt-3 text-sm">
                {error || "No approval documents found."}
              </p>
              <p className="text-slate-400 text-xs mt-1">
                Both artifacts become available after municipal approval.
              </p>
            </div>
          ) : (
                ...
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                      ...
                      <h2 className="text-xl font-bold text-[#062E22] mt-1">
                        {verificationLetter.reference_number}
                      </h2>
                      <p className="text-sm text-slate-500 mt-2">
                        This PDF is separate from the permit and confirms the
                        final municipal approval record.
                      </p>
                    </div>
                    <button
                      type="button"
                  ...
                  <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-4 mt-5">
                    <div className="rounded-xl bg-slate-50 p-4">
                      ...
                      <p className="text-sm font-semibold text-[#062E22] mt-2">
                        {verificationLetter.organizer_name}
                      </p>
                    </div>
                    <div className="rounded-xl bg-slate-50 p-4">
                      <p className="text-[10px] uppercase tracking-wide text-slate-400">
                      ...
                      <p className="text-sm font-semibold text-[#062E22] mt-2">
                        {verificationLetter.ministry_office_name || "Not set"}
                      </p>
                    </div>
                    <div className="rounded-xl bg-slate-50 p-4">
                      <p className="text-[10px] uppercase tracking-wide text-slate-400">
                      ...
                      <p className="text-sm font-semibold text-[#062E22] mt-2">
                        {verificationLetter.municipal_office_name || "Not set"}
                      </p>
                    </div>
                    <div className="rounded-xl bg-slate-50 p-4">
                      <p className="text-[10px] uppercase tracking-wide text-slate-400">
                      ...
                      <p className="text-sm font-semibold text-[#062E22] mt-2">
                        {new Date(
                          verificationLetter.approval_timestamp,
                        ).toLocaleString()}
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                      ...
                      <p className="text-sm text-slate-500 mt-2">
                        The permit remains a distinct approval artifact
                        alongside the verification letter.
                      </p>
                    </div>
                    <button
                      type="button"
                  ...
                  <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-4 mt-5">
                    <div className="rounded-xl bg-slate-50 p-4">
                      ...
                      <p className="text-sm font-semibold text-[#062E22] mt-2">
                        {new Date(permit.issued_at).toLocaleString()}
                      </p>
                    </div>
                    <div className="rounded-xl bg-slate-50 p-4">
                      <p className="text-[10px] uppercase tracking-wide text-slate-400">
                      ...
                      <p className="text-sm font-semibold text-[#062E22] mt-2">
                        {permit.issued_by_office_name ||
                          permit.issued_by_role ||
                          "Not set"}
                      </p>
                    </div>
                    <div className="rounded-xl bg-slate-50 p-4">
                    ...
                    <div className="rounded-xl bg-slate-50 p-4">
                      ...
                      <p className="text-sm font-semibold text-[#062E22] mt-2 break-all">
                        {permit.proposal_id}
                      </p>
                    </div>
                  </div>
