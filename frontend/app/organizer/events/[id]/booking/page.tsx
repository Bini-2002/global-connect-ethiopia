        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
            ...
            <p className="text-sm text-slate-600 mt-4">
              Publish the event first, enable booking, then open the public attendee event page to create one real attendee reservation for the demo.
            </p>
          </div>
        </div>
      }
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
        ...
        <div className="grid md:grid-cols-2 gap-4 mt-8 pt-6 border-t border-slate-100">
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
            <p className="font-semibold text-amber-800">Waitlist disabled in Phase 1</p>
            <p className="text-sm text-amber-700 mt-1">When capacity is full, new bookings are rejected immediately.</p>
          </div>
          <div>
          ...
          <div className="md:col-span-2">
            <label className="text-sm font-medium text-slate-700">Required Attendee Fields</label>
            <input
            ...
            <p className="text-xs text-slate-500 mt-2">
              These fields will be required from attendees on the public booking form.
            </p>
          </div>
        </div>
